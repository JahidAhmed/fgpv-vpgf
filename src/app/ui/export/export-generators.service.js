(() => {
    ...
    function exportGenerators($q, $filter, $translate, $templateCache, gapiService, configService, graphicsService,
        exportLegendService, geoService) {
        ...
        function mapLocalGenerator(exportSize) {
            const localGeneratorPromise =
                    gapiService.gapi.mapPrint.printLocal(geoService.mapObject, exportSize);
        ...
        function mapServerGenerator(exportSize, showToast) {
            ...
            function serverPrint(exportMapUrl, attempt = 0) {
                const serverPromise = gapiService.gapi.mapPrint.printServer(geoService.mapObject, {
                    url: exportMapUrl,
                    format: 'png32',
