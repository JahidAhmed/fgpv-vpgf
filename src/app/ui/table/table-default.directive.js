        ...
        function createTable(oLang) {
           ...
           function getDateFilter(config) {
            ...
            function onTableInit() {
                ...
                forcedDelay.then(requestId => {
                    ...
                    if (self.tableBody) {
                        ...
                        const refreshInterval = legendEntry.proxyWrapper.layerConfig.cachedRefreshInterval;
            ...
            function onZoomClick(rowNumber) {
                ...
                const proxy = requester.legendEntry.proxyWrapper.proxy;

                geoService.zoomToFeature(proxy, oid);
            }
